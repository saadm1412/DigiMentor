...
const Register = () => {
    const [isStudentRegister, setIsStudentregister] = useState(true);
        ...
        <div className="flex flex-col items-center min-h-screen bg-pink-100">
            {isStudentRegister ? (
                <div className="bg-white p-6 rounded shadow-md w-full max-w-md mt-28">
                    <h2 className="text-center text-xl mb-4">Register as Student</h2>
                    <form>
                        <div className="mb-4">
                    ...
                    <p className="text-center mt-4">
                        or <span className="text-red-500 cursor-pointer" onClick={() => setIsStudentregister(false)}>Register as Mentor</span>
                    </p>
                </div>
            ) : (
                <div className="bg-white p-8 rounded shadow-md w-full max-w-md mt-28">
                    <h2 className="text-center text-xl mb-4">Register as Mentor</h2>
                    <form>
                        <div className="mb-4">
                    ...
                    <p className="text-center mt-4">
                        or <span className="text-red-500 cursor-pointer" onClick={() => setIsStudentregister(true)}>Register as Student</span>
                    </p>
                </div>
            )}
        </div>
